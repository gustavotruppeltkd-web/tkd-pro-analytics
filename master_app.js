...
function openScoutDetail(scoutId) {
    ...
    const dataFormatada = dataObj.toLocaleDateString('pt-BR') + ' Ós ' + dataObj.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' });
...
async function downloadScoutPDF(scoutId) {
    ...
    doc.text("AN┴LISE DE PERFORMANCE - SCOUT", 15, 15);
    ...
    doc.text("AÃıES OFENSIVAS (FEITAS)", 20, yPos + 4.5);
    doc.text("AÃıES DEFENSIVAS (SOFRIDAS)", 115, yPos + 4.5);
    yPos += 10;
